...
#1.4 ¿Cúal de los países tiene un mayor uso de internet?

data[data$Internet.users == max(data$Internet.users),]

#1.5 Obtener el país con la tasa de nacimientos más alta

data[data$Birth.rate == max(data$Birth.rate),]

#1.6 El país del punto 4 ¿A qué nivel de ingresos pertenece?

data$Income.Group[data$Internet.users == max(data$Internet.users)]

#1.7 Obtener el valor de correlación entre nacimientos/internet
...
#2.5 Graficar con qplot y dar a cada región un color
